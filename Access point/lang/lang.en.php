<?php
	...
	$language["connect_txt"] = "This allows your Telraam to connect to the internet through your <b>Wi-Fi network</b>. Please take care and avoid writing errors.";
	...
	$language["service_not_running"]="telraam_ap_control_service not found";
	$language["interrupt_sent"]="Connection is being established";
	$language["connect_now"]="Connect now";
	$language["save_and_connect"] = "Save and connect";
	$language["connection_error"] = "Connection to the TELRAAM hotspot lost";
	$language["making_the_connection_title"] = "Connecting to your wifi";
